  ...
  return (
    <div className="mb-268">
      ...
      <div className="flex w-100% flex-wrap mt-23">
        <label className="relative shadow-3 rounded-8 mb-20 md:mr-20 cursor-pointer">
          <input className="hidden input-teplate-select absolute" type="radio" value="template1" name="template" onChange={handleChange} />
          <div className="absolute w-100% h-100% inset-0 rounded-8 bg-gray9 opacity-40"></div>
          <div className="absolute bottom-10 right-10">
            <CheckBox1 fontSize={17} size={40} color={'#ffffff'} background={'#2dde98'} />
          </div>
          <img className="rounded-8" src="/assets/step1img.png" />
        </label>
        <label className="relative shadow-3 rounded-8 mb-20 cursor-pointer">
          <input className="hidden input-teplate-select absolute" type="radio" value="template2" name="template" onChange={handleChange} />
          <div className="hidden absolute w-100% h-100% inset-0 rounded-8 bg-gray9 opacity-40"></div>
          <div className="absolute bottom-10 right-10">
            <CheckBox1 fontSize={17} size={40} color={'#ffffff'} background={'#2dde98'} />
          </div>
          <img className="rounded-8" src="/assets/step11.png" />
        </label>
        <label className="relative shadow-3 rounded-8 md:mr-20 cursor-pointer">
