...
export const Step4: FC = () => {
  ...
  return (
    <div className="mb-150">
      <div className="text-gray9 text-22 font-medium">Sed ut ratione neque disputatione, quam interrogare.</div>
      <div className="flex flex-col w-100% flex-wrap mt-30">
        <div className="text-14 font-medium text-gray9 mt-20 mb-9">Title</div>
        <input
