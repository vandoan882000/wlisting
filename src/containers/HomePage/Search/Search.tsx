      ...
      <div className="row justify-center pt-30">
        <div className="col-lg-10 flex flex-col">
          ...
          <div className="flex flex-wrap rounded-10 border-1 border-gray2 mt-18 shadow-2">
            <div className="md:w-1/2 md-max:w-100% h-75 flex flex-col py-10 px-10">
              <div className="text-14 font-medium text-gray8 ml-10">Find</div>
              <input
                type="text"
                className="text-15 font-normal text-gray5 border-none pt-0"
            ...
            <div className="flex justify-between items-center md:w-1/2 md-max:w-100% h-75 border-l-1 border-l-gray2 pr-15">
              <div className="w-75% h-75 flex flex-col py-10 px-10">
                ...
                <input
                  type="text"
                  className="text-15 font-normal text-gray5 border-none focus:border-none focus:border-light focus:outline-none focus:shadow-sm-light pt-0"
                  style={{ boxShadow: 'none' }}
