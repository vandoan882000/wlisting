...
export const SliderNumber: FC<SliderNumberProps> = ({ value, min, max, step, onChange, onChanged }) => {
  ...
  return (
    <>
      <div ref={setReferenceElement} className="veda-slider w-90% mr-15 h-4 bg-gray3 relative select-none">
        <div
