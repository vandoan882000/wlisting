...
} = ({ children, onApply, title, variant = 'box', containerStyle = {}, onClear = () => {} }) => {
      ...
      {visible &&
        createPortal(
          <div className="!w-100% h-100% fixed top-0 left-0 p-20% flex justify-center items-center z-100">
            ...
            <div
              className={` border-gray3 border-1 ${variant == 'box' ? 'w-95% md:w-40% rounded-10' : 'w-100% h-100%'} bg-light p-15`}
