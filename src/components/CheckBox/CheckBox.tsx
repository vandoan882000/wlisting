...
export const CheckBox: FC<CheckBoxProps> = ({ disabled = false, borderStyle, checked }) => {
  return (
    <label
      id=""
    ...
    >
      <input type="checkbox" name="check-listing" id="checklisting" className="hidden" disabled={disabled} checked={checked} />
      <div
